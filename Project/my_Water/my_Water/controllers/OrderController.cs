...
namespace Orders.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetFullOrder( [FromServices] UserDBContext user_context , [FromBody] UserOrderDtos dto  , [FromServices] GameDBContext game_context ) 
        {
